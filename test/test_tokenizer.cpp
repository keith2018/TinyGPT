...
static std::vector<float> tokens0 = {31373, 995, 0};

static std::string str1 = "Thanks for putting me into the right direction";
static std::vector<float> tokens1 = {9690, 329, 5137, 502, 656, 262, 826, 4571};

static std::string str2 = "hello，你好啊, thanks";
static std::vector<float> tokens2 = {31373, 171, 120, 234, 19526, 254, 25001,
                                     121, 161, 243, 232, 11, 5176};

static std::string str3 = " ありがとうございます。 Arigatoo gozaimasu";
static std::vector<float> tokens3 = {23294, 224, 28255, 35585, 30201, 29557,
                                     2515, 242, 2515, 244, 18566, 30159,
                                     33623, 16764, 943, 328, 265, 2238, 467, 89,
                                     1385, 27345};
